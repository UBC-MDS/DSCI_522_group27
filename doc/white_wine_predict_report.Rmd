...
```{r table_1, echo=FALSE, fig.cap="Table 1. Table of crossover results for each tested model.", out.width = '60%'}
...
```{r table_2, echo=FALSE, fig.cap="Table 2. Correlation plot of the correlation between features in the white wine dataset.", out.width = '60%'}
path <- "../results/tuned_crossval_results.feather"
kable(read_feather(path))
```
