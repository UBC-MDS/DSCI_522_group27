...
results/quality_distributions_figure.png: data/test_df.feather data/train_df.feather data/raw_data.csv
	python src/eda_figures.py data raw_data.csv results

# fit, tune and test model
results/weights_figure.png results/initial_crossval_results.feather results/tuned_crossval_results.feather results/tuned_test_results.feather results/reduced_tuned_crossval_results.feather results/reduced_tuned_test_results.feather: data/test_df.feather data/train_df.feather 
